    ...
    <div className="min-h-screen bg-[#080b10] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[#00e5a0] text-black text-xl mb-4">
            ⚡
          </div>
        ...
        <p className="text-center text-xs text-slate-500 mt-6">
          Não tem conta?{" "}
          <a href="/registro" className="text-[#00e5a0] hover:underline">
            Criar conta
          </a>
        </p>
      </div>
